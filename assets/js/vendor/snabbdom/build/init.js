...
export function init(modules, domApi, options) {
  ...
  function createElm(vnode, insertedVnodeQueue) {
    ...
    (_a = hook === null || hook === void 0 ? void 0 : hook.init) === null ||
    _a === void 0
      ? void 0
      : _a.call(hook, vnode);
    ...
    if (sel === "!") {
      ...
      if (hook !== undefined) {
        (_c = hook.create) === null || _c === void 0
          ? void 0
          : _c.call(hook, emptyNode, vnode);
      ...
      ((_d =
        options === null || options === void 0
          ? void 0
          : options.experimental) === null || _d === void 0
        ? void 0
        : _d.fragments) &&
      vnode.children
    ) {
      vnode.elm = (
        (_e = api.createDocumentFragment) !== null && _e !== void 0
          ? _e
  ...
  function patchVnode(oldVnode, vnode, insertedVnodeQueue) {
    ...
    if (
      ...
      (_d = oldVnode.data) !== null && _d !== void 0
        ? _d
        : (oldVnode.data = {});
      ...
      (_g =
        (_f =
          (_e = vnode.data) === null || _e === void 0 ? void 0 : _e.hook) ===
          null || _f === void 0
          ? void 0
          : _f.update) === null || _g === void 0
        ? void 0
        : _g.call(_f, oldVnode, vnode);
    }
    ...
    (_h = hook === null || hook === void 0 ? void 0 : hook.postpatch) ===
      null || _h === void 0
      ? void 0
      : _h.call(hook, oldVnode, vnode);
  }
