...
defimpl JSEncoder, for: IfExpression do
  import Hologram.Commons.Encoder, only: [encode_as_arrow_function: 3]
  ...
  def encode(
    ...
    condition_anon_fun = encode_as_arrow_function(condition_block, context, opts)

    do_anon_fun = encode_as_arrow_function(do_block, context, opts)
    else_anon_fun = encode_as_arrow_function(else_block, context, opts)
