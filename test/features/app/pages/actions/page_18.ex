defmodule HologramFeatureTests.Actions.Page18 do
  use Hologram.Page

  alias HologramFeatureTests.Components.Actions.Component20
  ...
  def template do
    ~HOLO"""
    {%if @show_component?}
      <Component20 cid="component_20" />
    {%else}
      Component20 is hidden
    {/if}
    <p>
