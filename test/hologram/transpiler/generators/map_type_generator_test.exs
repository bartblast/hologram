defmodule Hologram.Transpiler.Generators.MapTypeGeneratorTest do
  ...
  describe "generate_data/1" do
    ...
    test "not nested data" do
      ...
      result = MapTypeGenerator.generate_data(data)
      expected = "{ '~Hologram.Transpiler.AST.AtomType[a]': { type: 'integer', value: 1 }, '~Hologram.Transpiler.AST.AtomType[b]': { type: 'integer', value: 2 } }"
    ...
    test "nested data" do
      ...
      result = MapTypeGenerator.generate_data(data)
      expected = "{ '~Hologram.Transpiler.AST.AtomType[a]': { type: 'integer', value: 1 }, '~Hologram.Transpiler.AST.AtomType[b]': { type: 'map', data: { '~Hologram.Transpiler.AST.AtomType[c]': { type: 'integer', value: 2 }, '~Hologram.Transpiler.AST.AtomType[d]': { type: 'map', data: { '~Hologram.Transpiler.AST.AtomType[e]': { type: 'integer', value: 3 }, '~Hologram.Transpiler.AST.AtomType[f]': { type: 'integer', value: 4 } } } } } }"
