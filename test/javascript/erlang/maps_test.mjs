...
describe("Erlang_Maps", () => {
    ...
    describe("fold/3", () => {
        ...
        it("raises ArgumentError if the first argument is not an anonymous function", () => {
            assertBoxedError(
                ...
                "ArgumentError",
                Interpreter.buildArgumentErrorMsg(1, "not a fun that takes three arguments")
            );
        });
    ...
    describe("iterator/1", () => {
        ...
        it("not a map", () => {
            assertBoxedError(() => iterator(atomAbc), "BadMapError", "expected a map, got: :abc");
        });
    });
    ...
    describe("keys/1", () => {
        ...
        it("not a map", () => {
            assertBoxedError(() => keys(atomAbc), "BadMapError", "expected a map, got: :abc");
        });
    });
    ...
    describe("map/2", () => {
        const fun = Type.anonymousFunction(
            ...
            [
                {
                    params: (_context) => [Type.matchPlaceholder(), Type.variablePattern("value")],
                    guards: [],
                    body: (context) => {
        ...
        it("raises ArgumentError if the first argument is not an anonymous function", () => {
            assertBoxedError(
                ...
                "ArgumentError",
                Interpreter.buildArgumentErrorMsg(1, "not a fun that takes two arguments")
            );
        });
    ...
    describe("to_list/1", () => {
        ...
        it("raises BadMapError if the argument is an iterator", () => {
            const iterator = Type.tuple([Type.atom("a"), Type.integer(1), Type.atom("none")]);
