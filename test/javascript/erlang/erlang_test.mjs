...
describe("Erlang", () => {
  ...
  describe("list_to_integer/2", () => {
    ...
    describe("sign handling", () => {
      ...
      it("positive zero", () => {
        const result = list_to_integer(
          Type.list([Type.integer(43), Type.integer(48)]),
          Type.integer(10),
        );
        const expected = Type.integer(0);
      ...
      it("negative zero", () => {
        const result = list_to_integer(
          Type.list([Type.integer(45), Type.integer(48)]),
          Type.integer(10),
        );
        const expected = Type.integer(0);
    ...
    describe("error cases", () => {
      ...
      it("raises ArgumentError if list contains any whitespace", () => {
        const whitespaceLists = [
          Type.list([
            Type.integer(32),
            Type.integer(49),
            Type.integer(50),
          ...
          Type.list([Type.integer(32)]),
          Type.list([Type.integer(49), Type.integer(32), Type.integer(50)]),
        ];

        for (const list of whitespaceLists) {
          assertBoxedError(
            () => list_to_integer(list, Type.integer(10)),
            "ArgumentError",
            Interpreter.buildArgumentErrorMsg(
              1,
              "not a textual representation of an integer",
      ...
      it("raises ArgumentError on sign only", () => {
        assertBoxedError(
          () =>
