...
describe("Interpreter", () => {
  ...
  // IMPORTANT!
  // What each shape renders as is pinned against Elixir's own rendering in
  // test/elixir/hologram/ex_js_consistency/stacktrace_test.exs.
  ...
  describe("formatStacktrace()", () => {
    ...
    const render = (...frames) =>
      Interpreter.formatStacktrace(Type.list(frames));
