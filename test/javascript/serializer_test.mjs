    ...
    describe("boxed terms", () => {
      ...
      describe("float", () => {
        it("top-level", () => {
          ...
          const expected = '[2,"__float__:1.23"]';
        ...
        it("nested", () => {
          ...
          const expected = '[2,{"a":"__float__:1.23","b":2}]';
      ...
      describe("list", () => {
        it("top-level", () => {
          ...
          const expected =
            '[2,{"type":"list","data":["__integer__:1","__float__:1.23"],"isProper":true}]';
        ...
        it("nested", () => {
          ...
          const expected =
            '[2,{"a":{"type":"list","data":["__integer__:1","__float__:1.23"],"isProper":true},"b":2}]';
      ...
      describe("tuple", () => {
        it("top-level", () => {
          ...
          const expected =
            '[2,{"type":"tuple","data":["__integer__:1","__float__:1.23"]}]';
        ...
        it("nested", () => {
          ...
          const expected =
            '[2,{"a":{"type":"tuple","data":["__integer__:1","__float__:1.23"]},"b":2}]';
    ...
    describe("JS terms", () => {
      describe("array", () => {
        it("top-level", () => {
          ...
          const expected = '[2,[123,"__float__:2.34","b:a0:4"]]';
        ...
        it("nested", () => {
          ...
          const expected = '[2,{"a":[123,"__float__:2.34","b:a0:4"],"b":2}]';
        ...
        it("not versioned", () => {
          const term = [123, Type.float(2.34), Type.bitstring2([1, 0, 1, 0])];
          const expected = '[123,"__float__:2.34","b:a0:4"]';
