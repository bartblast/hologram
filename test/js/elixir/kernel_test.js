...
describe("if()", () => {
  it("returns doClause result if condition is truthy", () => {
    ...
    const condition = (function() { return Type.boolean(true) })
    const doClause = (function() { return expected })
    const elseClause = (function() { return Type.integer(2) })
  ...
  it("returns elseClause result if condition is not truthy", () => {
    ...
    const condition = (function() { return Type.boolean(false) })
    const doClause = (function() { return Type.integer(1) })
