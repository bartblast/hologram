defmodule Hologram.BenchmarksTest do
  ...
  defp count_added_modules(modules, old_module_info_plt, new_module_info_plt) do
    Enum.reduce(modules, 0, fn module, acc ->
      case {PLT.get(old_module_info_plt, module), PLT.get(new_module_info_plt, module)} do
  ...
  defp count_edited_modules(modules, old_module_info_plt, new_module_info_plt) do
    Enum.reduce(modules, 0, fn module, acc ->
      case {PLT.get(old_module_info_plt, module), PLT.get(new_module_info_plt, module)} do
  ...
  defp count_removed_modules(modules, old_module_info_plt, new_module_info_plt) do
    Enum.reduce(modules, 0, fn module, acc ->
      case {PLT.get(old_module_info_plt, module), PLT.get(new_module_info_plt, module)} do
  ...
  defp count_untouched_modules(modules, old_module_info_plt, new_module_info_plt) do
    Enum.reduce(modules, 0, fn module, acc ->
      case {PLT.get(old_module_info_plt, module), PLT.get(new_module_info_plt, module)} do
  ...
  describe "generate_module_info_plts/2" do
    test "100% added modules, 0% removed modules, 0% edited modules, 0% untouched modules", %{
      module_info_plt: module_info_plt,
      num_modules: num_modules
    } do
      {old_module_info_plt, new_module_info_plt} = generate_module_info_plts(1.0, 0.0, 0.0)

      assert PLT.size(old_module_info_plt) == 0
      assert PLT.size(new_module_info_plt) == num_modules

      assert PLT.get_all(new_module_info_plt) == PLT.get_all(module_info_plt)
    end
    ...
    test "0% added modules, 100% removed modules, 0% edited modules, 0% untouched modules", %{
      ...
      {old_module_info_plt, new_module_info_plt} = generate_module_info_plts(0.0, 1.0, 0.0)

      assert PLT.size(old_module_info_plt) == num_modules
      assert PLT.size(new_module_info_plt) == 0

      assert PLT.get_all(old_module_info_plt) == PLT.get_all(module_info_plt)
    end
    ...
    test "0% added modules, 0% removed modules, 100% edited modules, 0% untouched modules", %{
      ...
      {old_module_info_plt, new_module_info_plt} = generate_module_info_plts(0.0, 0.0, 1.0)
      ...
      Enum.each(modules, fn module ->
        assert PLT.get!(old_module_info_plt, module) != PLT.get!(new_module_info_plt, module)
      end)
    end
    ...
    test "0% added modules, 0% removed modules, 0% edited modules, 100% untouched modules", %{
      ...
      {old_module_info_plt, new_module_info_plt} = generate_module_info_plts(0.0, 0.0, 0.0)
    ...
    test "10% added modules, 20% removed modules, 30% edited modules, 40% untouched modules", %{
      ...
      {old_module_info_plt, new_module_info_plt} = generate_module_info_plts(0.1, 0.2, 0.3)
      ...
      assert PLT.size(old_module_info_plt) == num_modules - expected_num_added_modules
      assert PLT.size(new_module_info_plt) == num_modules - expected_num_removed_modules

      num_added_modules =
        count_added_modules(modules, old_module_info_plt, new_module_info_plt)

      assert num_added_modules == expected_num_added_modules

      num_removed_modules =
        count_removed_modules(modules, old_module_info_plt, new_module_info_plt)

      assert num_removed_modules == expected_num_removed_modules

      num_edited_modules =
        count_edited_modules(modules, old_module_info_plt, new_module_info_plt)

      assert num_edited_modules == expected_num_edited_modules

      num_untouched_modules =
        count_untouched_modules(modules, old_module_info_plt, new_module_info_plt)
    ...
    test "literal number of modules", %{
      ...
      {old_module_info_plt, new_module_info_plt} = generate_module_info_plts(1, 2, 3)
    ...
    test "sum of float args greater than 1.0" do
      assert {%PLT{}, %PLT{}} = generate_module_info_plts(0.2, 0.3, 0.5)

      assert_raise ArgumentError,
                   "the sum of the arguments in case they are floats must be less than or equal to 1.0",
                   fn ->
                     generate_module_info_plts(0.2, 0.3, 0.501)
                   end
    end
    ...
    test "first float arg less than 0.0" do
      ...
      assert_raise ArgumentError, expected_msg, fn ->
        generate_module_info_plts(-0.1, 0.2, 0.3)
      end
    end
    ...
    test "first integer arg less than 0" do
      ...
      assert_raise ArgumentError, expected_msg, fn ->
        generate_module_info_plts(-1, 2, 3)
      end
    end
    ...
    test "mixed type of arguments" do
      ...
      assert_raise ArgumentError, expected_msg, fn ->
        generate_module_info_plts(1, 2.0, 3)
      end
    end
  end
end
