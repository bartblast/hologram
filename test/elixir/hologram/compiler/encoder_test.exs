defmodule Hologram.Compiler.EncoderTest do
  ...
  describe "encode_client_term!/1" do
    test "replaces server-only attribute values with the sentinel" do
      ...
      expected =
        normalize_newlines("""
        Type.map([[Type.atom("__meta__"), Type.map([[Type.atom("__struct__"), Type.atom("Elixir.Hologram.Entity.Metadata")], [Type.atom("attribute_changes"), Type.map([])], [Type.atom("claim"), Type.atom("nil")], [Type.atom("relationship_ops"), Type.map([])], [Type.atom("revisions"), Type.map([])]])], [Type.atom("__struct__"), Type.atom("Elixir.Hologram.Test.Fixtures.Entity.Module15")], [Type.atom("created_at"), Type.atom("nil")], [Type.atom("id"), Type.bitstring("test-id-1")], [Type.atom("label"), Type.bitstring("Report")], [Type.atom("secret_note"), Type.map([[Type.atom("__struct__"), Type.atom("Elixir.Hologram.Entity.ServerOnly")], [Type.atom("attribute"), Type.atom("secret_note")]])], [Type.atom("token"), Type.map([[Type.atom("__struct__"), Type.atom("Elixir.Hologram.Entity.ServerOnly")], [Type.atom("attribute"), Type.atom("token")]])], [Type.atom("updated_at"), Type.atom("nil")]])\
        """)
