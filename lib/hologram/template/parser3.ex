defmodule Hologram.Template.Parser3 do
  ...
  defp merge_tokens([], :start_tag_bracket, context, _acc) do
    message = "Unclosed tag at the end of the template"
    raise_error(message, context, [], :start_tag_bracket, nil)
  end

  defp merge_tokens([], :start_tag, context, _acc) do
    message = "Unclosed tag at the end of the template"
    raise_error(message, context, [], :start_tag, nil)
  end
