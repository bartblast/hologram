defmodule Hologram.Compiler.CallGraph do
  ...
  @erlang_mfa_edges [
    ...
    {{:unicode, :_characters_to_normalized_binary, 2}, {:unicode, :_raise_invalid_chardata, 0}},
    {{:unicode, :_characters_to_normalized_binary, 2},
     {:unicode, :_split_at_utf8_validity_boundary, 1}},
    {{:unicode, :_characters_to_normalized_binary, 2}, {:unicode, :characters_to_binary, 3}},
    {{:unicode, :_encode_as_utf32_big_endian, 2}, {:unicode, :_encode_with_fixed_width, 4}},
    {{:unicode, :_encode_as_utf32_little_endian, 2}, {:unicode, :_encode_with_fixed_width, 4}},
    {{:unicode, :_parse_utf16_binary, 2}, {:unicode, :_convert_codepoint_to_binary, 1}},
    {{:unicode, :_parse_utf16_binary, 2}, {:unicode, :_ensure_bytes_from_binary, 1}},
    {{:unicode, :_parse_utf32_binary, 2}, {:unicode, :_convert_codepoint_to_binary, 1}},
    {{:unicode, :_parse_utf32_binary, 2}, {:unicode, :_ensure_bytes_from_binary, 1}},
    {{:unicode, :_process_chardata_list, 3}, {:unicode, :_raise_invalid_chardata, 0}},
    {{:unicode, :_split_at_utf8_validity_boundary, 1}, {:unicode, :_find_valid_utf8_prefix, 1}},
    {{:unicode, :characters_to_binary, 1}, {:unicode, :characters_to_binary, 3}},
    {{:unicode, :characters_to_binary, 3}, {:unicode, :_handle_binary_input_cttb, 3}},
    {{:unicode, :characters_to_binary, 3}, {:unicode, :_handle_integer_input_cttb, 3}},
    {{:unicode, :characters_to_binary, 3}, {:unicode, :_handle_list_input_cttb, 2}},
    {{:unicode, :characters_to_binary, 3}, {:unicode, :_raise_invalid_chardata, 0}},
    {{:unicode, :_encode_to_target_encoding_cttb, 3}, {:unicode, :_encode_as_latin1, 2}},
    {{:unicode, :_encode_to_target_encoding_cttb, 3},
     {:unicode, :_encode_as_utf16_big_endian, 2}},
    {{:unicode, :_encode_to_target_encoding_cttb, 3},
     {:unicode, :_encode_as_utf16_little_endian, 2}},
    {{:unicode, :_encode_to_target_encoding_cttb, 3},
     {:unicode, :_encode_as_utf32_big_endian, 2}},
    {{:unicode, :_encode_to_target_encoding_cttb, 3},
     {:unicode, :_encode_as_utf32_little_endian, 2}},
    {{:unicode, :_handle_binary_input_cttb, 3}, {:unicode, :_build_error_tuple, 2}},
    {{:unicode, :_handle_binary_input_cttb, 3}, {:unicode, :_build_incomplete_tuple, 2}},
    {{:unicode, :_handle_binary_input_cttb, 3}, {:unicode, :_encode_to_target_encoding_cttb, 3}},
    {{:unicode, :_handle_binary_input_cttb, 3}, {:unicode, :_ensure_bytes_from_binary, 1}},
    {{:unicode, :_handle_binary_input_cttb, 3}, {:unicode, :_parse_input_encoding_cttb, 2}},
    {{:unicode, :_handle_binary_input_cttb, 3}, {:unicode, :_split_at_utf8_validity_boundary, 1}},
    {{:unicode, :_handle_integer_input_cttb, 3}, {:unicode, :_convert_codepoint_to_binary, 1}},
    {{:unicode, :_handle_integer_input_cttb, 3}, {:unicode, :_encode_to_target_encoding_cttb, 3}},
    {{:unicode, :_handle_integer_input_cttb, 3}, {:unicode, :_raise_invalid_chardata, 0}},
    {{:unicode, :_handle_list_input_cttb, 2}, {:unicode, :_build_error_tuple, 2}},
    {{:unicode, :_handle_list_input_cttb, 2}, {:unicode, :_encode_to_target_encoding_cttb, 3}},
    {{:unicode, :_handle_list_input_cttb, 2}, {:unicode, :_handle_utf8_error_cttb, 3}},
    {{:unicode, :_handle_list_input_cttb, 2}, {:unicode, :_process_element_cttb, 2}},
    {{:unicode, :_handle_list_input_cttb, 2}, {:unicode, :_raise_invalid_chardata, 0}},
    {{:unicode, :_handle_utf8_error_cttb, 3}, {:unicode, :_build_error_tuple, 2}},
    {{:unicode, :_handle_utf8_error_cttb, 3}, {:unicode, :_build_incomplete_tuple, 2}},
    {{:unicode, :_handle_utf8_error_cttb, 3}, {:unicode, :_encode_to_target_encoding_cttb, 3}},
    {{:unicode, :_handle_utf8_error_cttb, 3}, {:unicode, :_ensure_bytes_from_binary, 1}},
    {{:unicode, :_handle_utf8_error_cttb, 3}, {:unicode, :_split_at_utf8_validity_boundary, 1}},
    {{:unicode, :_parse_input_encoding_cttb, 2}, {:unicode, :_convert_codepoint_to_binary, 1}},
    {{:unicode, :_parse_input_encoding_cttb, 2}, {:unicode, :_ensure_bytes_from_binary, 1}},
    {{:unicode, :_parse_input_encoding_cttb, 2}, {:unicode, :_parse_utf16_binary, 2}},
    {{:unicode, :_parse_input_encoding_cttb, 2}, {:unicode, :_parse_utf32_binary, 2}},
    {{:unicode, :_process_element_cttb, 2}, {:unicode, :_convert_codepoint_to_binary, 1}},
    {{:unicode, :_process_element_cttb, 2}, {:unicode, :_encode_to_target_encoding_cttb, 3}},
    {{:unicode, :characters_to_list, 1}, {:lists, :flatten, 1}},
    {{:unicode, :characters_to_list, 1}, {:unicode, :_convert_binary_to_codepoints, 3}},
    {{:unicode, :characters_to_list, 1}, {:unicode, :_convert_codepoint_to_binary, 1}},
    {{:unicode, :characters_to_list, 1}, {:unicode, :_ensure_bytes_from_binary, 1}},
    {{:unicode, :characters_to_list, 1}, {:unicode, :_find_valid_utf8_prefix, 1}},
    {{:unicode, :characters_to_list, 1}, {:unicode, :_process_chardata_list, 3}},
    {{:unicode, :characters_to_list, 1}, {:unicode, :_raise_invalid_chardata, 0}},
    {{:unicode, :characters_to_list, 1}, {:unicode, :_split_at_utf8_validity_boundary, 1}},
    {{:unicode, :characters_to_nfc_binary, 1}, {:unicode, :_characters_to_normalized_binary, 2}},
    ...
    {{:unicode, :characters_to_nfc_list, 1}, {:unicode, :_convert_binary_to_codepoints, 3}},
    {{:unicode, :characters_to_nfc_list, 1}, {:unicode, :_convert_codepoint_to_binary, 1}},
    {{:unicode, :characters_to_nfc_list, 1}, {:unicode, :_process_chardata_list, 3}},
    {{:unicode, :characters_to_nfc_list, 1}, {:unicode, :_raise_invalid_chardata, 0}},
    {{:unicode, :characters_to_nfd_binary, 1}, {:unicode, :_characters_to_normalized_binary, 2}},
    {{:unicode, :characters_to_nfkc_binary, 1}, {:unicode, :_characters_to_normalized_binary, 2}},
    {{:unicode, :characters_to_nfkd_binary, 1}, {:unicode, :_characters_to_normalized_binary, 2}},
