defmodule Hologram.Compiler.CallGraph do
  ...
  @erlang_mfa_edges [
    ...
    {{:unicode_util, :_cpl, 2}, {:unicode_util, :_cpl, 2}},
    ...
    {{:unicode_util, :_cpl_1_cont2, 1}, {:unicode_util, :_cpl_1_cont2, 1}},
    ...
    {{:unicode_util, :_cpl_1_cont3, 1}, {:unicode_util, :_cpl_1_cont3, 1}},
    ...
    {{:unicode_util, :_cpl_cont, 2}, {:unicode_util, :_cpl_cont, 2}},
    ...
    {{:unicode_util, :_cpl_cont2, 2}, {:unicode_util, :_cpl_cont2, 2}},
    {{:unicode_util, :_cpl_cont2, 2}, {:unicode_util, :_is_cp, 1}},
    {{:unicode_util, :_cpl_cont3, 2}, {:unicode_util, :_cpl_1_cont3, 1}},
    {{:unicode_util, :_cpl_cont3, 2}, {:unicode_util, :_cpl_cont3, 2}},
