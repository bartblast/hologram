...
Benchee.run(
  %{
    "build_page_js/5" => fn {call_graph, ir_plt, async_mfas, js_dir} ->
      Compiler.build_page_js(Page1, call_graph, ir_plt, async_mfas, js_dir)
    end
  },
  before_scenario: fn _input ->
    ...
    {call_graph_for_pages, ir_plt, async_mfas, js_dir}
  end,
  formatters: [
